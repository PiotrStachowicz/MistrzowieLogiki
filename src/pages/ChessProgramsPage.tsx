  ...
  en: [
    {
      ...
      title: 'First moves at the chessboard.',
      description:
        'Children learn the pieces and rules through play, puzzles and short games.',
    ...
    },
    {
      ...
      title: 'Time for tactics and strategy.',
      description:
        'We move from reinforcing the rules to planning and simple combinations.',
    ...
    },
    {
      ...
      title: 'Training tailored to the student.',
      description:
        'The student’s level, games and goal shape the way we work.',
    ...
    },
    {
      ...
      title: 'We learn from one another.',
      description:
        'Every game is a chance to discover another idea and test your own.',
    ...
    },
    {
      ...
      title: 'Chess at your institution.',
      description:
        'We tailor the programme to the group and provide the instructor and equipment.',
    ...
    },
    {
      ...
      title: 'A team around one chessboard.',
      description:
        'Chess becomes a space for teamwork, conversation and friendly competition.',
...
const chessCopy = {
  ...
  en: {
    ...
    heroTitle: 'Chess begins with thinking.',
    heroLead:
      'We help students understand the position, find a plan and choose a move independently.',

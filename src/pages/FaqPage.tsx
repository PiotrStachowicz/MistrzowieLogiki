...
const faqCopy = {
  ...
  en: {
    ...
    heroTitle: 'Questions? Start here.',
    heroLead: 'Choose a topic and quickly find the answer you need.',
    heroPrimary: 'Choose a topic',
    contact: 'Contact',
    scroll: 'Explore the topics',
    mapEyebrow: 'Quick map',
    mapTitle: 'What would you like to know?',
    mapLead: 'Choose a category or use the search.',

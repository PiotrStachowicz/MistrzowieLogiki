  ...
  en: [
    {
      ...
      title: 'We begin exactly where the student loses the thread.',
      description:
        'During the lesson, we break the current topic into smaller steps and return to the foundations it relies on. The pace follows the actual difficulty.',
    ...
    },
    {
      ...
      title: 'A shared working rhythm, with time for individual questions.',
      description:
        'A small group adds regularity and shows that a problem can be approached in different ways. The tutor can still pause at a difficult step.',
    ...
    },
    {
      ...
      title: 'An exam paper shows what to review — not only a score.',
      description:
        'We combine topic-based revision with exam questions. We look at instructions, scoring and the mistakes that most often consume time.',
    ...
    },
    {
      ...
      title: 'The syllabus divided into topics that can be practised calmly.',
      description:
        'We set an order for revision, return to the formulas that matter and work regularly with open questions and complete papers.',
...
const mathCopy = {
  ...
  en: {
    ...
    heroTitle: 'Math makes sense when every step is clear.',
    heroLead:
      'Current schoolwork, rebuilding gaps and preparation for the Grade 8 exam or Matura — at a pace that leaves room for real work.',
